...
function [A, B] = _fct_AB_tp(nu, zeta)
  ...
  A_poly = {
    ...
    [-2.698633097062688100e-4, 3.686607906143003560e-4, 6.937355413545889740e-4]
  };
  B_poly = {
    [
    ...
    [2.528601609445752130e-4, 7.110486511670866890e-4, 5.522130767212927900e-4]
  };
  
  inv_nu2 = power(nu, -2);
  A = polyval(A_poly{k_max}, zeta);
  B = polyval(B_poly{k_max}, zeta);
  for k = (k_max-1):(-1):1
